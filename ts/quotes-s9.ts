export const quotes: QuoteArrayType = [
    ...
    { author: `Dr. Seuss`, text: `When something bad happens you have three choices. You can either let it define you, let is destroy you, or you can let it strengthen you.` },
    ...
    { author: `Rick Rubin`, text: `Learn to recognize when something is good, even when it's not what you intended it to be.` },
    ...
    { author: `Unknown Author`, text: `Sometimes you have to forget what you feel and remember what you deserve.` },
    { author: `Unknown Author`, text: `Whoever brings you the most peace should get the most time.` },
    { author: `Unknown Author`, text: `You either quit or keep going. They both hurt.` },
